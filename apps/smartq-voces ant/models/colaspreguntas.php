...
class Colaspreguntas extends ActiveRecord {
	...
	/**
	 * Método para establecer el valor del campo colas_id
	 * @param integer $colas_id
	 */
	public function setColasId($colas_id){
		$this->colas_id = $colas_id;
	}
	...
	/**
	 * Devuelve el valor del campo colas_id
	 * @return integer
	 */
	...
	protected function initialize(){
		...
		$this->belongsTo('colas_id','turnos','id');
	}
