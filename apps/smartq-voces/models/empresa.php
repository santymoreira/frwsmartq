...
class Empresa extends ActiveRecord {
	 ...
	 * @var integer
	 */
	protected $servidor_node;
        
        /**
	 * @var integer
	 */
	protected $configura_sucursales;
	 ...
	 */
	public function setServidorNode($servidor_node){
		$this->servidor_node = $servidor_node;
	}
	 ...
	 * @param integer $pantalla_ticket
	 */
	public function setConfiguraSucursales($configura_sucursales){
		$this->configura_sucursales = $configura_sucursales;
	}

	        /**
	 * M�todo para establecer el valor del campo areas
	 * @param integer $areas
	 */
	 ...
	 * @return integer
	 */
	public function getServidorNode(){
		return $this->servidor_node;
	}
	 ...
	 * @return integer
	 */
	public function getConfiguraSucursales(){
		return $this->configura_sucursales;
	}

	       /**
	 * Devuelve el valor del campo acciones
	 * @return integer
	 */
