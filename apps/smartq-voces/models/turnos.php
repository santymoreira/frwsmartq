...
class Turnos extends ActiveRecord {
	...
	/**
	 * Método para establecer el valor del campo transferido
	...
	/**
	 * Método para establecer el valor del campo nombre_usuario
	...
	/**
	 * Método para establecer el valor del campo numero_alias
	 * @param integer $numero_alias
	 */
	public function setNumeroAlias($numero_alias){
		$this->numero_alias = $numero_alias;
	}
	...
	/**
	 * Método para establecer el valor del campo id_username
	...
	/**
	 * Método para establecer el valor del campo valor_calificacion
	 * @param integer $valor_calificacion
	 */
	public function setValorCalificacion($valor_calificacion){
	...
	/**
	 * Devuelve el valor del campo transferido
	 * @return integer
	 */
	...
	/**
	 * Devuelve el valor del campo nombre_usuario
	 * @return string
	 */
	...
	/**
	 * Devuelve el valor del campo numero_alias
	 * @return integer
	 */
	public function getNumeroAlias(){
		return $this->numero_alias;
	}
	...
	/**
	 * Devuelve el valor del campo id_username
	 * @return integer
	 */
	...
	/**
	 * Devuelve el valor del campo valor_calificacion
	 * @return integer
	 */
