...
class Pantalla extends ActiveRecord {
	 ...
	 * @var string
	 */
	protected $ip_senal_tv;
        
        /**
	 * @var string
	 */
	protected $llamado_con_tecla;
 ...
 /**
	 ...
	 * @param integer $ventana
	 */
	public function setTipoVoz($tipo_voz){
	 ...
	 * @param integer $ventana
	 */
	public function setIpSenalTv($ip_senal_tv){
		$this->ip_senal_tv = $ip_senal_tv;
	}
	 ...
	 * @param integer $ventana
	 */
	public function setLlamadoConTecla($llamado_con_tecla){
		$this->llamado_con_tecla = $llamado_con_tecla;
	}
	 ...
	 * @return integer
	 */
	public function getTipoVoz(){
		return $this->tipo_voz;
	}
	 ...
	 * @return integer
	 */
	public function getIpSenalTv(){
		return $this->ip_senal_tv;
	}
	 ...
	 * @return integer
	 */
	public function getLlamadoConTecla(){
		return $this->llamado_con_tecla;
	}
