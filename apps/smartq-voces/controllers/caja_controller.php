...
class CajaController extends ApplicationController {
    ...
    public function indexAction() {
        ...
        $columnsGrid[] = array('name' => 'Calificador', 'index' => 'ip_calificador');
...
//        }
    ...
    public function editarAction($id = null) {
        ...
        if ($caja) {
            ...
            Tag::displayTo('ip_calificador', $caja->getIpCalificador());
    ...
    public function guardarAction($isEdit = false, $id = null) {
        ...
        $ip_calificador = $this->getPostParam("ip_calificador");
        ...
        $caja->setIpCalificador($ip_calificador);
    ...
    public function obtenerDatosGridAction() {
        ...
        for ($i = $inicio; $i < $limite; $i++) {
            ...
            $jqgrid->rows[] = array('id' => $Caja->getId(), 'cell' => array($Caja->getNumeroCaja(), $Caja->getIp(), $Caja->getDescripcion(), $tipo_calificacion, $horario, $transferir_uno, $transferir_todos, $ubicacion, $Caja->getTiempo(), $Caja->getIpCalificador()));
        }
