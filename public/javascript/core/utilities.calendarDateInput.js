...
function BuildCalendarDays() {
   ...
   var HTML = '<table width="'+(CellWidth * 7)+'" cellspacing="0" cellpadding="0" style="cursor:default">';
...
function disableDateInput(name){
  	document.getElementById("x"+name+"_Month_ID").disabled = true;
	document.getElementById("x"+name+"_Day_ID").disabled = true;
	document.getElementById("x"+name+"_Year_ID").disabled = true;
}
