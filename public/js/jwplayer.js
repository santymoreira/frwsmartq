    ...
    (function(a){
        ...
        a.html5.view=function(l,D,g){
                ...
                for(var R=0;R<S.length;R++){
                    ...
                    if(c.exists(h.plugins.object[V].getDisplayElement)){
                        if(h.plugins.config[V].currentPosition!=a.html5.view.positions.NONE){
                            ...
                            b(h.plugins.object[V].getDisplayElement(),{
                                display:"none"
                            })
                        }
                    }
            ...
            function o(P,Q){
                ...
                return{
                    position:"absolute",
                    width:(c.getElementWidth(m)-c.parseDimension(m.style.right)),
                    height:(c.getElementHeight(m)-c.parseDimension(m.style.bottom)),
                    zIndex:Q
                }
            }
            function d(P,Q){
