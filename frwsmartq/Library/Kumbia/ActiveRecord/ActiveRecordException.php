 ...
 * @version 	$Id: ActiveRecordException.php 5 2009-04-24 01:48:48Z gutierrezandresfelipe $
 */
...
class ActiveRecordException extends CoreException {
	...
	public static function displayWarning($title, $message, $source){
		...
		print "<pre style='border:1px solid #969696;background:#FFFFE8;color:black;font-size:11px'>";
