...
function RSS_Display_Pantalla($url, $size = 15, $carpeta="", $site = 0, $withdate = 0) {
    global $RSS_Content;
    ...
    foreach($recents as $article) {
        ...
        if($description != false) {
            //$page .= "<br><span class='rssdesc'>$description</span>";
            //$page.= "<img src='../../img/$carpeta/sistema/separador.png' width='20px' height='20px' alt='guion'/> &middot; $title,";
        }
        //$page .= "</li>\n";
