...
class SesionesController extends ApplicationController {
    ...
    public function indexAction() {
        ...
        $columnsGrid[]=array('name'=>'Módulo','index'=>'caja_id','width'=>'60px');
        $columnsGrid[]=array('name'=>'Ubicación','index'=>'ubicacion_id','width'=>'75px');
        $columnsGrid[]=array('name'=>'Estado','index'=>'estado','width'=>'110px');
        ...
        $columnsGrid[]=array('name'=>'Duración','index'=>'duracion','width'=>'80px');
    ...
    public function obtenerDatosGridAction() {
        ...
        for($i=$inicio;$i<$limite;$i++) {
            ...
            if($Sesiones->getEstado()=="Inactivo")
                $estado='<font color="#3366FF"><b>Sesión terminada</b></font>';
            else if($Sesiones->getEstado()=="Incompleta")
                $estado='<font color="red"><b>Sesión mal cerrada</b></font>';
