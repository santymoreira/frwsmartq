...
class Spreadsheet_Excel_Writer_Worksheet extends Spreadsheet_Excel_Writer_BIFFwriter {
     ...
     * @access private
     */
    public function __construct($BIFF_version, $name, $index, $activesheet,
                                                $firstsheet, $str_total, $str_unique, $str_table, $url_format, $parser){
     ...
     * @access private
     */
    private private function _initialize(){
