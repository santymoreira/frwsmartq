 ...
 * @version 	$Id: Report.php 5 2009-04-24 01:48:48Z gutierrezandresfelipe $
 */
...
class Report extends Object {
	...
	public function __construct($adapter){
		...
		if(class_exists($className)==false){
			...
			if(Core::fileExists($classPath)){
				require "Library/Kumbia/Report/Adapters/$adapter.php";
			} else {
	...
	public function __call($method, $args){
		if(method_exists($this->_adapter, $method)==false){
			throw new ReportException("No existe el m&eacute;todo '$method' en el Adaptador '{$this->_adapterName}'");
		}
