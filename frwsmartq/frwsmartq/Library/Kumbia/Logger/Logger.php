 ...
 * @version 	$Id: Logger.php 5 2009-04-24 01:48:48Z gutierrezandresfelipe $
 */

/**
 * @see LoggerInterface
 */
require 'Library/Kumbia/Logger/Interface.php';

/**
 * @see LoggerInterface
 */
require 'Library/Kumbia/Logger/LoggerAdapter.php';

/**
 * @see LoggerItem
 */
require 'Library/Kumbia/Logger/LoggerItem.php';
