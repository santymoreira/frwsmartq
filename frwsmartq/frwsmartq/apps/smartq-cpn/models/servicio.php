...
class Servicio extends ActiveRecord {
    ...
    protected $prioridad_cantidad;
    /**
     * @var string
     */
    protected $tiempo_maximo;

    protected $letra_alias;

    protected $atencion_preferencial;
    ...
    public function setGruposervicioId($gruposervicio_id) {
     ...
     public function setPrioridadCantidad($prioridad_cantidad) {
        $this->prioridad_cantidad = $prioridad_cantidad;
    }
     ...
     * @param string $tiempo_maximo
     */
    public function setLetraAlias($letra_alias) {
        $this->letra_alias = $letra_alias;
    }

    public function setAtencionPreferencial($atencion_preferencial) {
        $this->atencion_preferencial = $atencion_preferencial;
    }
    ...
    public function getPrioridadCantidad() {
        return $this->prioridad_cantidad;
    }
    /**
     ...
     * @return string
     */
    public function getLetraAlias() {
        return $this->letra_alias;
    }

    public function getAtencionPreferencial() {
        return $this->atencion_preferencial;
    }
