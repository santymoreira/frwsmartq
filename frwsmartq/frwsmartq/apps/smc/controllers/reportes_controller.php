...
//        die();
        ...
        $html="";
        //INICIO ENCABEZADO
//        $html1="<center><h2>Reporte de Turnos Emitidos por el Dispensador<br>Desde $desde hasta $hasta</h2></center>";
        //FIN ENCABEZADO
//        $html.="<script type='text/javascript' src='../../js/ventana_secundaria.js'></script>";
        //$html.="<link href='../../css/tabla.css' rel='stylesheet' type='text/css' media='screen' />";
//        $html.="<link href=../../css/varios/style.css rel=stylesheet type=text/css />";
//	$html.="<script type=text/javascript src=../../js/scripts/jquery-1.3.2.min.js></script>";
//	$html.="<script type=text/javascript src=../../js/scripts/scrolltable.js></script>";
        $fondo_titulo= "background-color:#328aa4; color:#fff";
        $html.="<table style='width: 1200px' cellpadding='0' cellspacing='0' border='1'>";
        ...
        $html.="<tr>";
        $html.="<td style='$fondo_titulo;width: 80px'>Fecha</td>";
        $html.="<td style='$fondo_titulo;width: 60px'>Dia</td>";
        $html.="<td style='$fondo_titulo;width: 60px'>Primer Turno</td>";
        $html.="<td style='$fondo_titulo;width: 60px'>Ultimo Turno</td>";
        foreach ($lista_servicios as $key) {
            $nom=$this->arrayServicios[$key];
            $html.="<td  colspan=$cont_encabezado style='$fondo_titulo' aling=center>$nom</td>";
        }
        $html.="<td aling=center style='$fondo_titulo;width: 30px' title='Total Turnos Emitidos' >TTE</td>";
        $html.="<td aling=center style='$fondo_titulo;width: 30px' title='Total Turnos Atendidos'>TTA</td>";
        $html.="<td aling=center style='$fondo_titulo;width: 30px' title='Total Turnos anulados'>TTa</td>";
        $html.="<td aling=center style='$fondo_titulo;;width: 30px'  title='Total Turnos no timbrados'>TTn</td>";
        $html.="</tr>";

        $html.="<tr>";
        $html.="<td style='$fondo_titulo'></td>
            <td style='$fondo_titulo'></td>
            <td style='$fondo_titulo'></td>
            <td style='$fondo_titulo'></td>";
        foreach ($lista_servicios as $nom_servicio) {
            foreach ($array_encabezado_servicio as $valor)
                $html.="<td style='$fondo_titulo' title='$valor[titulo]'>$valor[etiqueta]</td>";
        }
        $html.="<td style='$fondo_titulo'></td>";
        $html.="<td style='$fondo_titulo'></td>";
        $html.="<td style='$fondo_titulo'></td>";
        ...
        //$html.="<div style='overflow: auto;height: 400px; width: 1220px;' border=1>";
        //$html.="<table style='width: 1200px;' cellpadding='0' cellspacing='0' aling=center>";
            ...
            if ($dia!='S�bado' & $dia!='Domingo') {
                ...
                foreach ($lista_servicios as $key) {
                   $turnos_emitidos= $this->array_turnero[$fecha][$key]['t_emitidos'];;
                    ...
                    $html.="<td align='left' style='background-color:#FEE1BA;'>$turnos_emitidos</td>";
                    $html.="<td align='left' style='background-color:#e5f1f4;'>$turnos_atendidos</td>";
                    $html.="<td align='left' style='background-color:#e5f1f4;'>$turnos_anulados</td>";
                    $html.="<td align='left' style='background-color:#e5f1f4;'>$turnos_no_timbrados</td>";
                ...
                $html.="<td align='center' style='background-color:#e5f1f4;' title='No Timbrados Emitidos'>$subtotal_turnos_no_timbrados</td>";
                $html.="</tr>";
        ...
        foreach ($suma_totales_turnos_emitidos as $key=>$valor) {
            ...
            $html.="<td align='center' style='background-color:#FEE1BA;'><b>$suma_totales_turnos_no_timbrados[$key]</b></td>";
        ...
        $html.="<td align='center' style='background-color:#e5f1f4;width: 30px'><b>$grantotal_turnos_no_timbrados</b></td>";
        $html.="</tr></table>";
...
////        echo $html;
    ...
    */
    ...
    function encabezadoPorSemana() {
        $html="<table width=79%  align='right'><tr>";
        $fondo_titulo= "background-color:#328aa4; color:#fff";
...
//            $html.=$this->encabezadoPorSemana();
            ...
            foreach($forma_array_semanas as $num_semana=>$val) { //al numero de semanas
                ...
                $html.="<td>";
                $html.="<table>";
                $html.="<tr style='$fondo_titulo'><td>Módulo</td><td width=200px  align='left'>Usuario</td></tr>";
...
//       $html.="categories: [";//'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun','Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']";
    ...
    */
    public function verCuadroCajasAction() {
        ...
        //    $id_servicio=$this->getPostParam('servicio');gr
        $html="";
        $fondo_titulo= "background-color:#328aa4; color:#fff";
        $tituloEstilo="font-family: Lucida Grande,Lucida Sans Unicode,Verdana,Arial,Helvetica,sans-serif; font-size: 16px; color: #3E576F; text-anchor=middle zIndex=1";
...
//        $html.="</div>";
    ...
    public function GraficaBarras($titulo,$nombres,$total) {
        $strXML = "";
        $strXML = "<chart caption = 'Gráfico 1: $titulo' bgColor='#CDDEE5' baseFontSize='12' showValues='1' xAxisName='Módulos' formatNumberScale='0' thousandseparator='.' labelDisplay='ROTATE'>";
...
//            die();
        ...
        if($tipo=="barras") {
            $graficaCalidad=$this->GraficaBarras("Calidad de AtenciÃ³n",$nom,$tot);
        }else {
            $resultado=0;
...
//                die();
                $graficaCalidad=$this->Graficadorpie("Calidad Total de AtenciÃ³n",$lista_nombres,$lista_datos_suma);
            }
...
//        $lista_servicios=explode(",",$servicios);
        $html="";
        if ($cajas!="") {
            $condicion="fecha_inicio_atencion BETWEEN '$desde' AND '$hasta' AND {#Caja}.id IN($cajas)AND duracion>='00:00:05'" ;
