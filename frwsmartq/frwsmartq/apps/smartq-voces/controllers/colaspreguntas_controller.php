 ...
 * @version 1.0
 */
class ColaspreguntasController extends ApplicationController {
	...
	public function indexAction(){
		...
		$columnsGrid[]=array('name'=>'Turnos','index'=>'colas_id');
	...
	public function editarAction($id=null){
		...
		if($turnospreguntas){
			...
			Tag::displayTo('colas_id', $turnospreguntas->getcolasId());
	...
	public function guardarAction($isEdit=false,$id=null){
		...
		$colasId = $this->getPostParam("colas_id", "int");
		...
		$turnospreguntas->setcolasId($colasId);
