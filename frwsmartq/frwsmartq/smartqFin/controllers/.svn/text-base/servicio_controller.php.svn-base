...
class ServicioController extends ApplicationController {
    ...
    public function indexAction() {
        ...
        $columnsGrid[]=array('name'=>'Tiempo Máximo','index'=>'tiempo_maximo');
    ...
    public function obtenerDatosGridAction() {
        ...
        for($i=$inicio;$i<$limite;$i++) {
            ...
            $jqgrid->rows[]=array('id'=>$Servicio->getId(),'cell'=>array($Servicio->getNombre(),$Servicio->getLetra(),$Servicio->getDescripcion(),$nombre_ubicacion,$nombre_gruposervicio,$estado,$Servicio->getTiempoMaximo()));
