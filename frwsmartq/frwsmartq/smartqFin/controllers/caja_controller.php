...
class CajaController extends ApplicationController {
    ...
    public function guardarAction($isEdit=false,$id=null) {
        ...
        if ($transferirUno=="on") $transferirUno=1; else $transferirUno=0;
        $transferirTodos        = $this->getPostParam("transferir_todos");
        if ($transferirTodos=="on") $transferirTodos=1; else $transferirTodos=0;
    ...
    public function obtenerDatosGridAction() {
        ...
        for($i=$inicio;$i<$limite;$i++) {
            ...
            foreach ($array_op_calificacion as $key=>$valor) {
                if ($key==$tipo_calificacion) $tipo_calificacion=$valor;
            }
            //INICIO BUSCA TIPO CALIFICAICON
            ...
            $jqgrid->rows[]=array('id'=>$Caja->getId(),'cell'=>array($Caja->getNumeroCaja(),$Caja->getDescripcion(),$nombre_usuario,$tipo_operador,$tipo_calificacion,$Horario->getNombreHorario(),$transferir_uno,$transferir_todos,$Ubicacion->getNombreUbicacion()));
