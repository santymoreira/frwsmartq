...
class Funciones extends ActiveRecord {
    ...
    public function difFecha($fecha_inicio, $fecha_fin) {
        ...
        if($time>=0 && $time<=59) {
            ...
            $tiempo = "00:00:".$this->aumentaCerosTiempo($time);
            ...
            $tiempo = "00:".$this->aumentaCerosTiempo($premin[0]).':'.$this->aumentaCerosTiempo(round($sec,0));
            ...
            $tiempo = $this->aumentaCerosTiempo($prehour[0]).':'.$this->aumentaCerosTiempo($min[0]).':'.$this->aumentaCerosTiempo(round($sec,0));
    ...
    */
    ...
    /*
     * Permite sacar el día de la semana
    */
