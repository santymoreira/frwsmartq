...
class CajaController extends ApplicationController {
    ...
    public function indexAction() {
        ...
        $columnsGrid[] = array('name' => 'Tipo Calificación', 'index' => 'tipo_calificacion_operador');
    ...
    public function guardarAction($isEdit = false, $id = null) {
        ...
        if (empty($horario_id))
            ...
            //busco si ya esta asignada la ip //!importante, no borrar, puede servir si se desea que controle la ip ya registrada
