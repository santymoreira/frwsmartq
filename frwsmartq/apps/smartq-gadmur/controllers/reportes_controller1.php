...
class ReportesController extends ApplicationController {
    ...
    */
    ...
    /*
     * Inicio para el reporte de calificaciones por mÃƒÂ¯Ã‚Â¿Ã‚Â½dulos
    */
...
//        Tag::displayTo('hora_f', "17:00:00");
        //INICIO LISTA DE MÃƒÂ¯Ã‚Â¿Ã‚Â½DULOS
        ...
        //FIN LISTA DE MÃƒÂ¯Ã‚Â¿Ã‚Â½DULOS
...
//                        echo "hola".$val;
    ...
    */
    ...
    /*
     * Permite listas los servicios o los grupos de servicios segÃƒÂ¯Ã‚Â¿Ã‚Â½n la opciÃƒÂ¯Ã‚Â¿Ã‚Â½n seleccionada en turnosEmitidos.html
    */
    ...
    */
    public function verCuadroTurnosEmitidosAction() {
        ...
        foreach ($lista_servicios as $key) {
            ...
            $html.="<th colspan=$cont_encabezado style='$fondo_titulo'>$nom</th>";
        }
...
////        echo $html;
    ...
    */
    public function verGraficoTurnosEmitidosAction() {
        ...
        $html.="this.x +': '+ this.y +'ÃƒÂ¯Ã‚Â¿Ã‚Â½C';";
        $html.="}";
        $html.="},";
        $html.="plotOptions: {";
        $html.="line: {";
    ...
    function encabezadoPorDia() {
        ...
        $array_encabezado_dia=array(
                'TA'=>array('etiqueta'=>'TA','titulo'=>'Turnos Atendidos'),
                'Ta'=>array('etiqueta'=>'Ta','titulo'=>'Turnos Anulados'),
                'DT'=>array('etiqueta'=>'DT','titulo'=>'DuraciÃ³n Total'),
                'PA'=>array('etiqueta'=>'PA','titulo'=>'Promedio de AtenciÃ³n'),
...
//            $array_dias_semana = array('Lunes','Martes','MÃ­rcoles','Jueves','Viernes','SÃ¡bado','Domingo');
//            $array_encabezado_dia=array(
//                    'TA'=>array('etiqueta'=>'TA','titulo'=>'Turnos Atendidos'),
//                    'Ta'=>array('etiqueta'=>'Ta','titulo'=>'Turnos Anulados'),
//                    'DT'=>array('etiqueta'=>'DT','titulo'=>'DuraciÃ³n Total'),
...
//            $cont_encabezado=count($array_encabezado_dia);
            ...
            $tituloCabecera="<center><text style='$tituloEstilo'>Cuadro de turnos Atendidos, Anulados y Promedios<br />Desde ".$desde."hasta ". $hasta."</text></center>";
            ...
            foreach($forma_array_semanas as $num_semana=>$val) { //al numero de semanas
                $html.="<tr>";      //por cada semana un tr y dentro de este una tabla
                ...
                for ($i=1;$i<=$d;$i++) {
                    ...
                    $datos.="<td align='right' style='background-color:#FEE1BA;'>".$total_duracion_x_dia."</td>";
                    $datos.="<td align='right' style='background-color:#FEE1BA;'>".$total_promedio_x_dia."</td>";
                ...
                $html.="<td>";
                $html.="<table>";
                $html.="<tr style='$fondo_titulo'><td>Módulo</td><td>Usuario</td></tr>";
                //foreach($lista_modulos as $modulo_id) {
                foreach($this->array_datos_modulo as $val) {
                    $modulo_id= $val['modulo_id'];
                    $num_modulo= $val['numero'];
                    $usuario_modulo= $val['usuario'];
                    $html.="<tr><td align='left' style='background-color:#e5f1f4;'>$num_modulo</td>";
                    $html.="<td align='left' style='background-color:#e5f1f4;'>$usuario_modulo</td></tr>";
                }
                $html.="<tr><td></td><td align='left' style='background-color:#FEE1BA;'>Totales: </td></tr>";
                $html.="</table>";
                $html.="</td>";
                foreach($dias as $dia) {
                    $html.="<td>$array_datos[$dia]</td>";
                }
                ...
                foreach($this->array_datos_modulo as $val) {
                    ...
                    $html.="<td align='right' style='background-color:#FEE1BA;'>".$suma_promedio_t."</td>";
                    $html.="</tr>";
                }
                //totales por semana de todos los modulos
                $html.="</tr>";
                $html.="<td align='right' style='background-color:#FEE1BA;'>&nbsp;</td>";
                $html.="<td align='right' style='background-color:#FEE1BA;'></td>";
                $html.="<td align='right' style='background-color:#FEE1BA;'></td>";
                $html.="<td align='right' style='background-color:#FEE1BA;'></td>";
                $html.="</tr>";
                ...
                $compactada=serialize($mi_array);
                $compactada=urlencode($compactada);
                $html.="<input type='button' style='background-color:#e5f1f4;width:100px;height:20px;border-width:thin;border-style:solid;border-color:white;color:blue;' value='Graficar Semana' onclick="." \"verGraficoTotalSemanasTodos('$compactada')\""."/>";
                $html.="</td>";
                $html.="</tr>";
    ...
    */
    public function verGraficoHorasColas1Action() {
        ...
        $array_encabezado_hora=array(
                'TA'=>array('etiqueta'=>'TA','titulo'=>'Turnos Atendidos'),
                //'Ta'=>array('etiqueta'=>'Ta','titulo'=>'Turnos Anulados'),
                'DT'=>array('etiqueta'=>'DT','titulo'=>'DuraciÃƒÆ’Ã‚Â³n Total'),
                'PA'=>array('etiqueta'=>'PA','titulo'=>'Promedio de AtenciÃƒÆ’Ã‚Â³n')
        );
        $html.="<table align='center'>";
...
//       $html.="categories: [";//'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun','Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']";
    ...
    */
    public function verCuadroCajasAction() {
        ...
        $fondo_titulo= "background-color:#328aa4; color:#fff";
        $tituloEstilo="font-family: Lucida Grande,Lucida Sans Unicode,Verdana,Arial,Helvetica,sans-serif; font-size: 16px; color: #3E576F; text-anchor=middle zIndex=1";
        $tituloCabecera="<center><text style='$tituloEstilo'>Cuadro de Turnos, Duracion y Promedios<br />Desde ".$desde."hasta ". $hasta."</text></center>";
        ...
        $fondo_titulo= "background-color:#328aa4; color:#fff";
        $html.="<table align='center'>";
        $array_dias_semana = array('Lunes','Martes','MiÃ©rcoles','Jueves','Viernes','SÃ¡bado');
        $array_encabezado_dia=array(
                'TA'=>array('etiqueta'=>'TA','titulo'=>'Turnos Atendidos'),
                //'Ta'=>array('etiqueta'=>'Ta','titulo'=>'Turnos Anulados'),
                'DT'=>array('etiqueta'=>'DT','titulo'=>'DuraciÃƒÆ’Ã‚Â³n Total'),
        ...
        // $domingo=$totales_turnos_atendidos['Sunday'];
        ...
        $html.="<input type='button' style='background-color:#e5f1f4;width:100px;height:20px;border-width:thin;border-style:solid;border-color:white;color:blue; alig=center;' value='Graficar Semana'onclick="." \"verGraficoTotalSemanasTodos('$compactada')\""."/>";
        //echo $html;
        $datos= array("v1"=>$html,"titulo"=>$tituloCabecera);
//        print_r($datos);
        return ($datos);
    ...
    /*
     * Inicio de exportaciÃƒÂ¯Ã‚Â¿Ã‚Â½n a Excel de Turnos
    */
    ...
    /*
     * Inicio de exportaciÃƒÂ¯Ã‚Â¿Ã‚Â½n a Excel de Colas
    */
...
//        Tag::displayTo('hasta', date("Y-m-d"));
    ...
    /*
     * MenÃƒÂ¯Ã‚Â¿Ã‚Â½ para Reporte que muestra el cuador de los totales de turnos atendidos por dÃƒÂ¯Ã‚Â¿Ã‚Â½as
    */
    ...
    /*
     * MenÃƒÂ¯Ã‚Â¿Ã‚Â½ para Reporte que muestra los totales de colas atendidos por dÃƒÂ¯Ã‚Â¿Ã‚Â½as
    */
    ...
    */
    ...
    /*
     * Reporte que muestra los totales de turnos atendidos por MÃƒÂ¯Ã‚Â¿Ã‚Â½dulos
     * PDF
    */
    public function reporteTurnosAtendidosModuloAction() {
        ...
        //INICIO OBTENER LOS MÃƒÂ¯Ã‚Â¿Ã‚Â½DULOS
        if ($id_caja<>0) { //Si es <> 0, entonces seleccionÃƒÂ¯Ã‚Â¿Ã‚Â½ un mÃƒÂ¯Ã‚Â¿Ã‚Â½dulo
        ...
        } else { //Por caso contrario se ha seleccionado Todos los mÃƒÂ¯Ã‚Â¿Ã‚Â½dulos
            $cajas= new Caja();
        ...
        //FIN OBTENER LOS MÃƒÂ¯Ã‚Â¿Ã‚Â½DULOS
        $pdf->outputToBrowser();

    }

    /*
     * Reporte que muestra los totales de turnos atendidos por DÃƒÂ¯Ã‚Â¿Ã‚Â½as
     * PDF
    */
    public function reporteTurnosAtendidosDiasAction() {
        ...
        $pdf->writeCell(40, 7, "Reporte de Turnos atendidos por MÃƒÆ’Ã‚Â³dulo");
        $pdf->lineFeed();
        ...
        /*$lightGray = PdfColor::fromGrayScale(0.75);
        $pdf->setFillColor($lightGray);
        $pdf->writeCell(20, 7, 'MÃƒÆ’Ã‚Â³dulo', 0, 0, PdfDocument::ALIGN_LEFT);
        $pdf->writeCell(40, 7, 'Usuario', 0, 0, PdfDocument::ALIGN_LEFT);
        ...
        if ($id_caja<>0) { //Si es <> 0, entonces seleccionÃƒÂ¯Ã‚Â¿Ã‚Â½ un mÃƒÂ¯Ã‚Â¿Ã‚Â½dulo
            ...
            if ($id_servicio==0) {  //Todos los servicios y hacer consulta por cada dÃƒÂ¯Ã‚Â¿Ã‚Â½a
        ...
        } else { //Por caso contrario se ha seleccionado Todos los mÃƒÂ¯Ã‚Â¿Ã‚Â½dulos osea &id_caja==0
            //SELECT COUNT(*) AS total_dia FROM caja c, turnos t, servicio s, usercaja uc, usuario u
            //WHERE c.id=t.caja_id AND s.id=t.servicio_id AND c.id=uc.caja_id AND u.id=uc.usuario_id
            //AND fecha_inicio_atencion BETWEEN '2010-11-22' AND '2010-11-22' AND DAYNAME(fecha_emision)="Monday";
            $promedio_lunes=0;
     ...
     * filtro por mÃƒÂ¯Ã‚Â¿Ã‚Â½dulo y por servicio
    */
    public function reporteColasAtendidasCajaAction() {
        ...
        $pdf->writeCell(40, 7, 'DescripciÃƒÆ’Ã‚Â³n', 0, 0, PdfDocument::ALIGN_LEFT);
        $pdf->writeCell(35, 7, 'Usuario', 0, 0, PdfDocument::ALIGN_LEFT);
        //$pdf->writeCell(35, 7, 'Servicio', 0, 0, PdfDocument::ALIGN_LEFT);
        //$pdf->writeCell(15, 7, 'Turno', 0, 0, PdfDocument::ALIGN_LEFT);
        $pdf->writeCell(40, 7, 'F. inicio atenciÃƒÆ’Ã‚Â³n', 0, 0, PdfDocument::ALIGN_LEFT);
        $pdf->writeCell(40, 7, 'F. fin atenciÃƒÆ’Ã‚Â³n', 0, 0, PdfDocument::ALIGN_LEFT);
        $pdf->writeCell(20, 7, 'DuraciÃƒÆ’Ã‚Â³n', 0, 0, PdfDocument::ALIGN_LEFT);
        //$pdf->writeCell(20, 7, 'Calidad de Serv.', 0, 0, PdfDocument::ALIGN_LEFT);
        $pdf->lineFeed();
        ...
        //INICIO OBTENER LOS MÃƒÂ¯Ã‚Â¿Ã‚Â½DULOS
        if ($id_caja<>0) { //Si es <> 0, entonces seleccionÃƒÂ¯Ã‚Â¿Ã‚Â½ una caja
            //$condicion="numero_caja= $numero_caja";
            //SELECT numero_caja, nombres FROM caja c, turnos t, servicio s, usercaja uc, usuario u
            //WHERE c.id=t.caja_id AND s.id=t.servicio_id AND c.id=uc.caja_id AND u.id=uc.usuario_id
            //AND fecha_inicio_atencion BETWEEN '2010-08-17' AND '2010-08-17';
            ...
            for ($i=1;$i<=$d;$i++) {
                ...
                if (!empty($query)) {
                    ...
                    if ($num<>0) {
                        ...
                        $fun = new Funciones();
                        $duracion_total= $fun->tiempo($total_segundos);
                        $pdf->writeCell(40, 7, "DuraciÃƒÆ’Ã‚Â³n: ".$duracion_total, 0, 0,PdfDocument::ALIGN_LEFT);
                        $pdf->lineFeed();
                        $total_turnos_por_modulo+=$num;
                        $total_duracion_por_modulo_segundos+=$total_segundos;
                    }
    ...
    */
    public function reporteTurnosAtendidosModuloXlsAction() {
		...
		Please wait...
            ...
            $html.="<table class='tablesorter' id='Exportar_a_Excel' >
        <thead>";
            $html.="<tr>";
            $html.="<th>MÃ³dulo</th>";
            //$html.="<th>DescripciÃƒÆ’Ã‚Â³n MÃƒÆ’Ã‚Â³dulo</th>";
            $html.="<th>Usuario</th>";
            $html.="<th>Servicio</th>";
            $html.="<th>Letra</th>";
            $html.="<th>Num. turno</th>";
            $html.="<th>Fecha emisiÃ³n</th>";
            $html.="<th>Hora emisiÃ³n</th>";
            $html.="<th>Anulado</th>";
            $html.="<th>F. inicio atenciÃ³n</th>";
            $html.="<th>H. inicio atenciÃ³n</th>";
            $html.="<th>F. fin atenciÃ³n</th>";
            $html.="<th>H. fin atenciÃ³n</th>";
            $html.="<th>DuraciÃ³n</th>";
            $html.="</tr>
        </thead>
        <tbody>";
...
//        $html.="<p>Exportar a Excel  <img src='../../img/export_to_excel.gif' class='botonExcel' /></p>";
    ...
    /*
     * FunciÃƒÂ¯Ã‚Â¿Ã‚Â½n que exporta a excel
    */
     ...
     * Menu: EstadÃƒÂ¯Ã‚Â¿Ã‚Â½sticas de calificaciones
    */
    public function verCuadroCalificacionesAction() {
        ...
        if (!empty($lista_modulos) & !empty($lista_servicios)&!empty($preguntas)) {
            ...
            //INICIO ENCABEZADO
            $html="<center><h2>EstadÃ­sticas de Calificaciones<br>Desde $desde hasta $hasta</h2></center>";
            $html.="<table align='center'><tr><td>";
            $html.="<table align='left'>";
            $html.="<tr><td><b>Turnos con duraciÃ³n a partir de:</b></td><td align='right'>$forma_duracion</td></tr>";
            $html.="</table></tr></td>";
            //FIN ENCABEZADO
...
//                die();
                ...
                $array_fila[]=$array_pregunta;          //formo array multi para estÃƒÂ¯Ã‚Â¿Ã‚Â½ndar pero solo x pregunta
...
//                $html.="<td><a href=javascript:ventanaSecundaria('graficarPicos?array_serie=".$this->compactarArray($array_fila)."&array_categorias=".$this->compactarArray($lista_modulos)."&array_etiqueta_fila=".$this->compactarArray($this->lista_preguntas_calif)."&etiqueta_categoria=MOD.')>Graficar</a><td>";
                ...
                $html.="</tr>";
                $array_todos[]=$array_pregunta;         //formo array multi para estÃƒÂ¯Ã‚Â¿Ã‚Â½ndar todas las preguntas
            }
            $html.="<tr>";
            $html.="</tr>";
            $html.="</table>";
...
//            $html.="<a href=javascript:ventanaSecundaria('graficarPicos?array_serie=".$this->compactarArray($array_todos)."&array_categorias=".$this->compactarArray($lista_modulos)."&array_etiqueta_fila=".$this->compactarArray($this->lista_preguntas_calif)."&etiqueta_categoria=MOD.')>Graficar Todos</a>";
            ...
            $html.="No ha seleccionado algÃºn mÃ³dulo o servicio";
        echo $html;
    }

    /*
     * GrÃƒÂ¯Ã‚Â¿Ã‚Â½fico en picos
    */
...
//        $html.="</div>";
    ...
    public function GraficaBarras($titulo,$nombres,$total) {
        $strXML = "";
        $strXML = "<chart caption = 'GrÃ¡fico 1: $titulo' bgColor='#CDDEE5' baseFontSize='12' showValues='1' xAxisName='MÃ³dulos' formatNumberScale='0' thousandseparator='.' labelDisplay='ROTATE'>";
            ...
            if($titulo=="Calidad") {
                if(is_int($i/4)&&$i!=0) {
                    ...
                    if($i==2) {
                        ...
                        $strXML .= "<set  value ='".$lista_total[$key]."'/>";
                }
            }
            else {

                $nom=str_replace("BalcÃ³n", "Balcon",$lista_nombres[$key]);
                $nom=str_replace("CrÃ©dito", "Credito", $nom);
                $nom=str_replace("MÃ³dulo", "Modulo", $nom);
                $strXML .= "<set label = '".$nom. "' value ='".$lista_total[$key]."'/>";
            }
            $i++;
        }
...
//empieso a graficar
        ...
        if (!empty($id_caja)) {
            ...
            $strXML = "";
            $linkAnio=array();
            $strXML = "<chart caption = 'Grafico 1: Cajas' bgColor='#CDDEE5' baseFontSize='12' showValues='1' xAxisName='Cajas' formatNumberScale='0' thousandseparator='.' labelDisplay='ROTATE'>";
//        CALCULO EL TOTAL DE TURNOS ATENDIDOS Y ANULADOS
            $i=0;
            $totales=array();
            $reportes = new reportes();
...
//                $condicion="fecha_emision BETWEEN '$desde' AND '$hasta' AND c.id= $lista[$i] AND atendido=1 AND rechazado=0 AND s.id IN ($forma_condicion_servicios)"; //AND duracion>='$forma_duracion'" ;
//                $condicion_anulados="fecha_emision BETWEEN '$desde' AND '$hasta' AND c.id= $lista[$i] AND (rechazado=1 OR atendido=0) AND s.id IN ($forma_condicion_servicios)" ;
//                $tot_t_atendidos= $reportes->totalTurnosAtendidos($condicion);
//                $tot_t_anulados= $reportes->totalTurnosAnulados($condicion_anulados);
...
// Por ÃƒÂ¯Ã‚Â¿Ã‚Â½ltimo imprimo el grÃƒÂ¯Ã‚Â¿Ã‚Â½fico.
    ...
    public function Graficador1Action() {
        ...
        if (!empty($id_caja)and !empty($servicios)) {
            ...
            $strXML = "";
            $linkAnio=array();
            $strXML = "<chart caption = 'GrÃ¡fico 1: MÃ³dulos' bgColor='#CDDEE5' baseFontSize='12' showValues='1' xAxisName='Modulos' formatNumberScale='0' thousandseparator='.' labelDisplay='ROTATE'>";
//        CALCULO EL TOTAL DE TURNOS ATENDIDOS Y ANULADOS
            $i=0;
            $totales=array();
            $reportes = new reportes();
            ...
            foreach($this->array_total_modulos as $mod => $val) {
                $nom=str_replace("MÃ³dulo", "Modulo",$lista_nom[$mod]);
                // $linkModulo[$mod] = urlencode("\"javascript:detalleAnios('Modulo ".$cajas."', '".$total."');\"");
...
//                die();
    ...
    public function Graficador2Action() {
        ...
        $strXML = "";
        $strXML = "<chart caption = 'Grafico 2: Detalle ' bgColor='#CDDEE5' baseFontSize='12' >";
        $i=0;
    ...
    public function Graficadorpie($titulo,$listanombres,$listaTotales ) {
        ...
        if($titulo=="Calidad") {
            foreach($listaTotales as $key=>$val) {
                if(is_int($i/5)&&$i!=0) {
                    $j++;
                    $strXML .= "<set label = '".$listanombres[$j]. "' value ='".$listaTotales[$key]."'/>";
                }
                else {
        ...
        $strXML .= "</chart>";
        return $this->renderChartHTML("../../swf_charts/Pie3D.swf", "",$strXML, "detalle", 500, 480, false);
    }
...
//calcula los Totales
        ...
        if ($resultado!=0)
            $html=$this->Graficadorpie("Modulos",$lista1,$totales);
        else
            $html="NO HAY DATOS!!";
    ...
    public function  CalidadServicioAction() {
        ...
        foreach ($query->getResultSet() as $result) {
            foreach($lista_modulos as $val) {
                if ($val==$result->getId()) {
                    $lista[$j]="M".$result->getNumeroCaja()." - ".$result->getNombres();
                    $j++;
                }
            }
        }
        ...
        //INICIO BUSCAR CAJAS
        if ($modulos!="") {
            $condicion = "{#Grupousuario}.grupo_id = 5 and caja.id IN(".$modulos.")"; //operadores
            $query = new ActiveRecordJoin(array(
            ...
            foreach($query->getResultSet() as $result1) {
                ...
                while($row = $db->fetchArray($result)) {
                    ...
                    if ($calif=="Excelente")
                        ...
                        $regular=$row['total'];
//                    else if ($calif=="Insuficiente")
//                        $insuficiente=$row['total'];

                }

                $datos[] = array($cont, $excelente, $muybueno, $bueno, $regular);
//            $htmltabla.="<tr><td>$calif<td></tr><tr><td>$calif<td></tr></table></td>";
            }
...
//                $insuf[$key]=$fila[5]; //columna de malo
                $htmltabla.="<tr><td>".$lista[$key]."</td>";
...
//            $insuf = new aray();
        ...
        $series[0]=array('name'=>'Excelente','data'=>$data);
        $i=0;
        $data=array();
        foreach ($bue as $val) {
            $data[$i]=$val+0;
        ...
        $series[1]=array('name'=>'Muy Bueno','data'=>$data);
        $i=0;
        $data=array();
        foreach ($reg as $val) {
            $data[$i]=$val+0;
        ...
        $series[2]=array('name'=>'Bueno','data'=>$data);
        $i=0;
        $data=array();
        foreach ($mal as $val) {
            $data[$i]=$val+0;
        ...
        $series[3]=array('name'=>'Regular','data'=>$data);
        $i=0;
        $data=array();
        ...
        if($tipo=="barras") {
            $graficaCalidad=$this->GraficaBarras("Calidad",$nom,$tot);
        }else {
            $resultado=0;
            ...
            if ($resultado!=0)
                $graficaCalidad=$this->Graficadorpie("Calidad",$lista,$lista_datos);
...
//        $this->arrayModulosNombres=array();
        if($Areas!="") {
            ...
            //<fieldset class='ui-corner-all ui-widget-content'><legend><b>MÃƒÆ’Ã‚Â³dulos</b></legend>";
...
//        $lista1=array();
    ...
    public function GraficarChkGrupoAction() {
        ...
        if($cajas!="") {
////        $html.="<fieldset class='ui-corner-all ui-widget-content'>
//                                        <legend><b>Grupo Servicio</b></legend>
//                                        <br/>";
            ...
            $result = $db->query("SELECT * FROM gruposervicio gs,servicio s,serviciocaja sc  WHERE s.id=sc.servicio_id AND gs.id=gruposervicio_id  AND sc.caja_id IN ($cajas) GROUP BY gs.id ");
            while($row = $db->fetchArray($result)) {
                //  $areas[$i]= array('Id'=>$row[0],'nombre'=>$row[1]);
                $nombres[$i]=$row[1];
                $array_servicios[]=Tag::checkboxField("chkgruposervicio[]", "value: $row[0]","checked: ","onclick: chekGrupo()").$row[1]."&nbsp;&nbsp;";
                $i++;
            ...
            $html.= "</table>";
//                                   $html.="</fieldset>";
//                                     $html.="<div id='div_Servicios' align='center'>";
//                                        $html.="seleccione Grupos de Servicios..para ver Servicios!!";
//                                    $html.="</div>";
            $arraycks=array('cks'=>$html);
        }else
...
//                                             $html.=" </fieldset>";
    ...
    public $array_cuadro    =array();//para iniciliza el reporte turnero
    ...
    public function LLenaQueryAction() {
        ...
        if ($modulos!="") {
            ...
            $condicion="({#Caja}.id IN($modulos) OR {#Caja}.id IS NULL) AND fecha_emision BETWEEN '$desde' AND '$hasta' AND {#Servicio}.id IN ($servicios) AND duracion>='$forma_duracion'" ;
            $sql= new ActiveRecordJoin (array(
                            "entities" => array("Caja", "Turnos", "Servicio", "Usercaja", "Usuario"),
                            "fields" => array(
                                    "{#Caja}.id",
            ...
            foreach($sql->getResultSet() as $result) {
                ...
                if(($result->getAtendido()==1)&&($result->getRechazado()==0)) {
                    ...
                    //$this->array_cuadro[$key_fecha][$modulo_id]['promedio']+= $duracion_en_segundos;
                }
                if(($result->getAtendido()==1)&&($result->getRechazado()==1)) {
                    //array_turnero
                    $this->array_turnero[$key_fecha][$key_servicio_id]['t_anulados']+= 1;
                    //array_cuadro
                    $this->array_cuadro[$key_fecha][$modulo_id]['t_anulados']+= 1;
                }
...
//        $lista_servicios=explode(",",$servicios);
        $html="";
        if ($cajas!="") {
            $condicion="fecha_inicio_atencion BETWEEN '$desde' AND '$hasta' AND {#Caja}.id IN($cajas)AND duracion>='$forma_duracion'" ;
