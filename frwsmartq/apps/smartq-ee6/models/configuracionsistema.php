...
class Configuracionsistema extends ActiveRecord {
	...
	/**
	 * Método para establecer el valor del campo activar_calificador
	...
	/**
	 * Método para establecer el valor del campo activar_difusion
	...
	/**
	 * Método para establecer el valor del campo publicar_noticias
	...
	/**
	 * Método para establecer el valor del campo velocidad_publicacion
	...
	/**
	 * Método para establecer el valor del campo pc_difusion
	...
	/**
	 * Método para establecer el valor del campo puerto
	 * @param string $puerto
	 */
	...
	/**
	 * Método para establecer el valor del campo ver_tiempo_maximo
	...
	/**
	 * Método para establecer el valor del campo ver_tiempo_atencion
	...
	/**
	 * Método para establecer el valor del campo ubicacion_impresora
	...
	/**
	 * Método para establecer el valor del campo nombre_impresora
	...
	/**
	 * Método para establecer el valor del campo tono
	 * @param integer $tono
	 */
	...
	/**
	 * Método para establecer el valor del campo tiempo_tono
	...
	/**
	 * Método para establecer el valor del campo ventana
	...
	/**
	 * Método para establecer el valor del campo logo_sinticket
	...
	/**
	 * Método para establecer el valor del campo logo_conticket
	...
	/**
	 * Método para establecer el valor del campo logo_calificador
	...
	/**
	 * Método para establecer el valor del campo logo_ticket
	...
	/**
	 * Método para establecer el valor del campo pantalla_ticket
