...
//        $result = $db->query("SELECT cajanumero FROM displaycajas ORDER BY id ASC LIMIT 1");
    ...
    public function verNoticiasRssAction() {
        ...
        $html = '<marquee height="455px" scrollamount="' . $this->velocidad_publicacion . '" direction="' . $marquee_direccion . '" style="font-size: 40px; color:#' . $this->colorNoticias . '; background:transparent">' . $texo_amostrar . '</marquee>';
        echo $html;
