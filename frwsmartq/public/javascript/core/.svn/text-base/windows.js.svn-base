...
****************************************************************************
* (c) 2008 Andres Felipe Gutierrez <andresfelipe at vagoogle.net>
****************************************************************************/
...
WINDOW.open = function(properties){
	...
	if(!properties.titleBackground) properties.titleBackground = "url("+$Kumbia.path+"img/localnavg.gif)";
    ...
    left = (pageSize.windowWidth - (parseInt(properties.width)+36))/2;
	...
	"<tr><td style='background: url("+$Kumbia.path+"img/w.png);width:18px'></td>"+
	"<td style='width:"+properties.width+"px' aligh='center'>"+
	"<table cellspacing='0' style='background:"+properties.background+";width:100%'><tr>"+
	"<td align='center' style='cursor:move;color:#000000;background:"+properties.titleBackground+"'>"+
	properties.title+"</td></tr>"+
	"<tr><td id='windowData' style='padding:2px;border:1px solid #969696'></td>"+
	"</tr></table></td>"+
	"<td style='background: url("+$Kumbia.path+"img/e.png);width:18px'></td></tr>"+
	"<tr>"+
	"<td style='background: url("+$Kumbia.path+"img/sw.png);height:18px'>"+
	"<td style='background: url("+$Kumbia.path+"img/s.png);height:18px'>"+
	"<td style='background: url("+$Kumbia.path+"img/se.png);height:18px'>"+
	"</td></tr></table>";
	obj.innerHTML = html;
	obj.id = "myWindow"
	...
	obj.close = function(action){
		...
		new Effect.BlindUp("myWindow", {
			...
			afterFinish: function (){
				...
				document.body.removeChild($("shadow_win"))
				if(properties.onclose!=undefined){
					properties.onclose.call(this, action)
				}
				if(obj.onclose!=undefined){
					obj.onclose.call(this, action)
				}
			}
		})
	}
